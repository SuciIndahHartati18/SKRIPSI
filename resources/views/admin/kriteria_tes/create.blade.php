    ...
    <x-form.form action="{{ route('admin.kriteria_tes.store') }}">
        <x-form.container variant="label-input">
            ...
            <x-form.select name="nama_kriteria_tes" id="nama_kriteria_tes">
                <option value="Mengaji" {{ old('nama_kriteria_tes') === 'Mengaji' ? 'selected' : '' }}>Mengaji</option>
                <option value="Wawancara" {{ old('nama_kriteria_tes') === 'Wawancara' ? 'selected' : '' }}>Wawancara</option>
                <option value="Psikotes" {{ old('nama_kriteria_tes') === 'Psikotes' ? 'selected' : '' }}>Psikotes</option>
            </x-form.select>
        ...
        <x-form.container variant="label-input">
            ...
            <x-form.select name="tipe_kriteria_tes" id="tipe_kriteria_tes">
                <option value="benefit" {{ old('tipe_kriteria_tes') === 'benefit' ? 'selected' : '' }}>Benefit</option>
                <option value="cost" {{ old('tipe_kriteria_tes') === 'cost' ? 'selected' : '' }}>cost</option>
            </x-form.select>
